...
const Featured = () => {
  return (
    <div className="relative w-screen h-[700px] md:w-full md:h-screen">
      ...
      {/* Text & Button */}
      <div className="absolute text-left text-black items-start bottom-8 left-5 md:left-10 lg:left-64 flex flex-col gap-2 justify-end w-48">
        {/* The new header and button */}
        <h2 className="text-2xl md:text-3xl font-bold md:font-extrabold mb-2 md:mb-3 ">HEADWEAR</h2>
