...
const Footer = () => {
  ...
  return (
    <footer className="bg-black font-FuturaLight text-opacity-90 text-white p-0">
      {/* White Border Line */}
      <hr className="my-0 border-t  border-gray-400 w-full" />
      {/* Columns */}
      <div className="flex flex-col md:flex-row gap-2  md:gap-8 justify-between">
        {/* First Column */}
        {/* logo for md screens */}
        <div className=" -mt-3  hidden md:block ml-9">
          <Image
            src="/Merville.png"
            alt="Melville1 Logo"
            width={1000}
          ...
          <img
            ...
            alt="Melville1 Logo"
            className=" ml-2 mt-3 w-20 h-[84px]"
          />
        </div>

        {/* Second Column */}
        <div className=" ml-2 md:ml-0 mr-2 md:mr-0 mt-6 border-b border-gray-400 md:border-b-0 ">
          <h3
            onClick={() => toggleSection("client")}
            className=" font-FuturaMedium text-[11px] ml-4 mr-2 md:mr-0 md:ml-0 tracking-widest  mb-3 flex justify-between "
          >
            CLIENT SERVICE
            <span className="ml-2 md:hidden">
            {openSection === "client" ? (
                // Minus icon (when the section is open)
                <svg
                ...
                // Plus icon (when the section is closed)
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  fill="none"
                  viewBox="0 0 24 24"
        ...
        <div>
          <div className="ml-2 md:ml-0 mr-2 md:mr-0  mt-6 border-b border-gray-400 md:border-b-0 ">
            <h3
              ...
              className=" font-FuturaMedium ml-4 mr-2 md:mr-0 md:ml-0 tracking-widest text-[11px] mb-3 flex justify-between "
            >
              THE COMPANY
              <span className="ml-2 md:hidden">
              {openSection === "company" ? (
        ...
        <div className="mt-6  md:w-80  mr-2 md:mr-0 ml-2 md:ml-0    border-b border-gray-400 md:border-b-0 ">
          <h3
