...
const Receipt = () => {
  ...
  useEffect(() => {
    ...
    stripe.retrievePaymentIntent(clientSecret).then(({ paymentIntent }) => {
      ...
      // Access the orderId from PaymentIntent's metadata
  ...
  return (
    <div className=" mt-24  mb-8 flex flex-col items-center justify-center text-black mx-2 md:mx-0">
      ...
      <div className=" w-full md:w-[50%] mt-2 mb-2">
        <div className="flex ">
          <div className=" w-full  md:w-[50%] bg-gray-100 p-4 ">
            ...
            <p className="mb-4 font-FuturaLight tracking-widest">
              Ship to John Newman
            </p>

            <h3 className="text-lg font-FuturaMedium tracking-widest mb-4">
              Shipping Address
            </h3>
            ...
            <div className=" hidden md:flex ">
              <div>
                <div className=" mt-4 w-36 ">
                  <h3 className=" font-FuturaMedium tracking-widest  text-sm">
                    Shipping Method
                  </h3>
      ...
      <button className=" block md:hidden font-FuturaMedium tracking-widest bg-black text-white border p-4 w-44 mt-4">
        Print Receipt
      </button>
    </div>
  );
